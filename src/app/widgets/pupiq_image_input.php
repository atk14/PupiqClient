...
class PupiqImageInput extends FileInput{
	...
	function render($name, $value, $options=array()){
		...
		if(!$url){
			$image_tag = '<img src="'.$no_image_icon.'" width="100" height="100" class="img-thumbnail" style="border: none; margin-right: 12px; background-image: url(\''.$background_pattern.'"\');">';
			$image_tag .= '
				<br>
				...
				'</small>
			';
			$out = '<div class="form-control-wrap"><a class="pull-left">'.$image_tag.'</a>'.$out.'</div>'; //'<div style="clear: both;"></div>';
			return $out;
		}

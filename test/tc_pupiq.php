...
class TcPupiq extends TcBase{
	...
	function test__ExtractFilenameFromUrl(){
		...
		$this->assertEquals("city.jpg",Pupiq::_ExtractFilenameFromUrl("https://example.com/images/city.jpg"));
		$this->assertEquals("black hawk.jpg",Pupiq::_ExtractFilenameFromUrl("https://example.com/images/black%20hawk.jpg"));
		$this->assertEquals("flower.jpg",Pupiq::_ExtractFilenameFromUrl("https://example.com/images/flower.jpg?size=1"));
		$this->assertEquals("",Pupiq::_ExtractFilenameFromUrl("https://example.com/images/flower.jpg/?size=1"));
		$this->assertEquals("slash_.jpg",Pupiq::_ExtractFilenameFromUrl("https://example.com/images/slash%2f.jpg"));
	}
}
